...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        'base_url'          => base_url(),
        'site_url'          => site_url(),
        'favicon_url'       => base_url('assets/images/3.jpg'),
        'copyright_setup'   => 'Copyright &copy; 2019 - ' . date('Y') . '',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy; 2019 - ' . date('Y') . ' ' . get_pengaturan('nama-sekolah', 'value').' by MILF DEV - <a href=""></a>';
        $return['site_name'] = 'e-Lesson '.get_pengaturan('nama-sekolah', 'value');
...
function get_logo_url($size = 'small') {
    return base_url('assets/images/3.jpg');
}
